# CoH 2: Conspiracy Island AutoSplitter

An auto splitter for Code of Honor 2: Conspiracy Island.
...
```
target/wasm32-unknown-unknown/release/co_h2_auto_splitter.wasm
```
